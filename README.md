...
`placards.html`. Open the sheet in a browser, print at 100%, cut out the
...
Studio, Maker's Hive-1, Conference Room, Teacher's Cubicle, and the two main
stairs. Add or remove them in the builder.
